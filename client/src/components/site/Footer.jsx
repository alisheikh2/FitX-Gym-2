  ...
  return (
    <footer className="bg-[#0a0508] text-white">
      <div className="shell py-16 grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
        {/* brand */}
        <div>
          <h3 className="font-display font-extrabold uppercase text-lg tracking-wide">FITX</h3>
          <div className="mt-6 flex justify-start">
            <span className="h-28 w-28 rounded-full border-4 border-white flex items-center justify-center">
