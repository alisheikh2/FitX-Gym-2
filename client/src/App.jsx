...
import BoxingSession from './pages/public/BoxingSession.jsx';
import YogaSession from './pages/public/YogaSession.jsx';
import FamilySessions from './pages/public/FamilySessions.jsx';
    ...
    <AuthProvider>
      ...
      <Routes>
        <Route element={<PublicLayout />}>
          ...
          <Route path="/boxing-session" element={<BoxingSession />} />
          <Route path="/yoga-sessions" element={<YogaSession />} />
