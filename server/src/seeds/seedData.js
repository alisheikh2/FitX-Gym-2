...
export async function syncTestimonials() {
  ...
  // ---- Testimonials: real reviews & client results only (idempotent upserts) ----
    const quotes = [
    { kind: 'quote', name: 'Muhammad F.', source: 'Google Review', image: '/images/fitx/avatars/muhammad.jpg', text: 'I had an incredible experience at FITX, and I owe my fitness success to the amazing trainer, Zohaib Ali. His guidance and support not only helped me achieve my fitness goals but also allowed me to ditch medications for cholesterol and depression. Highly recommend!', sortOrder: 0 },
    { kind: 'quote', name: 'Hassan F.', source: 'Google Review', image: '/images/fitx/avatars/hassan.jpg', text: 'It has been a great experience for me. Highly recommend, as Zohaib Bhai is very sincere with every trainee, even with guys like me who left FITX due to a transfer from Sahiwal.', sortOrder: 1 },
    { kind: 'quote', name: 'A R J.', source: 'Google Review', image: '/images/fitx/avatars/arj.jpg', text: 'No doubt, FITX is one of the best personal training studios in the city. The staff is not only expert in their field but they also guide you how to be your own expert when it comes to health and fitness.', sortOrder: 2 },
    { kind: 'quote', name: 'Sami S.', source: 'Google Review', image: '/images/fitx/avatars/sami.jpg', text: 'FITX is one of the best gyms in Sahiwal for those who are struggling to lose weight. They have the best trainers and environment, all trainers are very friendly and give you the best advice. 10/10.', sortOrder: 3 },
    { kind: 'quote', name: 'Ali B.', source: 'Google Review', image: '/images/fitx/avatars/ali.jpg', text: 'One of the best personal training studios in the city, with expert trainers who guide you to be your own expert in health and fitness.', sortOrder: 4 }
  ];
