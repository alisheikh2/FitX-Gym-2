...
export async function syncTestimonials() {
  ...
  const quotes = [
    { kind: 'quote', name: 'Muhammad F.', source: 'Google Review', image: '/images/fitx/avatars/muhammad.jpg', text: 'No doubt, FITX is one of the best personal training studios in the city. The staff is not only expert in their field but they also guide you how to be your own expert when it comes to health and fitness. They are always there to motivate you and answer any question regarding fitness.', sortOrder: 0 },
    { kind: 'quote', name: 'Hassan F.', source: 'Google Review', image: '/images/fitx/avatars/hassan.jpg', text: 'FITX is one of the best gyms in Sahiwal for those who are struggling to lose weight. They have the best trainers, best environment, all trainers are very friendly and give you the best advice.', sortOrder: 1 },
    { kind: 'quote', name: 'Mehwish A.', source: 'Google Review', image: '/images/fitx/avatars/mehwish.jpg', text: 'It’s been a great experience for me. Highly recommend, as Zohaib Bhai is very sincere with every trainee, even with people like me who left FITX due to a transfer from Sahiwal.', sortOrder: 2 },
    { kind: 'quote', name: 'Sarwat M.', source: 'Google Review', image: '/images/fitx/avatars/sarwat.jpg', text: 'One of the best gyms in the city. Trainers are very cooperative and calm. Safe and secure for ladies.', sortOrder: 3 },
    { kind: 'quote', name: 'A R J.', source: 'Google Review', image: '/images/fitx/avatars/arj.jpg', text: 'The gym is spacious, clean and well-equipped, with a wide variety of machines and free weights suitable for all fitness levels. The trainers are knowledgeable and provide personalized workout plans that cater to individual goals.', sortOrder: 4 }
  ];
